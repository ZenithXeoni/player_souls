...
public class ExtractSoulProcedureProcedure {

	public static void execute(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PlayerSoulsMod.LOGGER.warn("Failed to load dependency world for procedure ExtractSoulProcedure!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PlayerSoulsMod.LOGGER.warn("Failed to load dependency entity for procedure ExtractSoulProcedure!");
			return;
		}
					...
					_player.displayClientMessage(Component.literal("\u00A73Your soul has been extracted, be careful who you give this to."), false);
				{
					...
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(
								...
								("/give @s player_souls:player_soul{display:{Lore:['{\"text\":\"Attachted Soul: " + "" + entity.getScoreboardName() + "\",\"color\":\"dark_aqua\",\"italic\":true}']},SoulPresent:1b, SoulControl:1b,"
										+ "KillBlocked:1b,Damage:" + (new Object() {
											public int getScore(String score, Entity _ent) {
												Scoreboard _sc = _ent.getLevel().getScoreboard();
												Objective _so = _sc.getObjective(score);
												if (_so != null)
